...
namespace Monogame___1_5
{
    ...
    public class Game1 : Game
    {
        ...
        Texture2D vikesHelmet, saintsHelmet, fieldTexture, footballTexture, touchdownTexture, introTexture;
        ...
        protected override void LoadContent()
        {
            ...
            touchdownTexture = Content.Load<Texture2D>("touchdown (1)");
            introTexture = Content.Load<Texture2D>("intro screen football");
        }
           ...
           protected override void Draw(GameTime gameTime)
        {
            ...
            if (vikesWR1.Top < 0)
            {
                _spriteBatch.Draw(touchdownTexture, new Rectangle(0,0,800,500), Color.White);
            }
            _spriteBatch.End();
